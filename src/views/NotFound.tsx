...
export const NotFound = () => {
  return (
    <div className="min-h-[calc(100vh-8rem)] flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 px-4 py-8">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center text-center space-y-6">
        <p className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-gray-900">
          404
        </p>
        <div className="space-y-4">
          <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-wider text-gray-900">
            ¡Whoops!
            <br className="sm:hidden" />
            <span className="sm:ml-2">La página no está 😔</span>
          </p>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 max-w-md mx-auto leading-relaxed">
            Lo siento, la página que buscabas no se pudo encontrar.
          </p>
        </div>
        <Link 
          to="/" 
          className="inline-flex items-center space-x-3 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
        ...
        >
          ...
          <span className="text-sm sm:text-base">Regresa al menú</span>
        </Link>
      </div>
