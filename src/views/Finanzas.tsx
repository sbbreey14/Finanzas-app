...
type Categoria = 'servicios_publicos' 
|  'internet/telefonia'
|  'seguros'
|  'suscripciones'
|  'otros' ;
...
export const Finanzas = () => {
  ...
  return (
    <div className="flex gap-8 w-full h-full">
      ...
      <div className="w-1/2">
        <form className="bg-white p-8 rounded-lg shadow-lg h-fit" onSubmit={ onSubmit }>
          <h2 className="text-2xl font-bold mb-6 text-gray-900">Agregar Servicio Básico</h2>
      ...
      <div className="w-1/2">
        <div className="bg-white p-8 rounded-lg shadow-lg h-fit">
          <h2 className="text-2xl font-bold mb-6 text-gray-900">Servicios Básicos</h2>
            ...
            <table className="w-full text-sm text-left text-gray-500">
              <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3">Emision</th>
              ...
              <tbody>
                {/* Ejemplo de filas - esto será dinámico */}
                {
                  ...
                  <tr className="bg-white border-b hover:bg-gray-50">
                    <td className="px-6 py-4 font-medium text-gray-900">{ finanza.nombreServicio }</td>
                    ...
                    <td className="px-6 py-4">
                      ...
                      <button className="text-red-600 hover:text-red-900" onClick={() => handleDelete(finanza.id)}>Eliminar</button>
                    </td>
                  </tr>
                  ))
                }
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            <div className="flex justify-between items-center">
              ...
              <span className="text-xl font-bold text-gray-900">$130.50</span>
            </div>
          </div>
        </div>
      </div>
